package com.example.beautify.ui;
...
import com.example.beautify.R;
import com.example.beautify.data.ArticleLoader;
...
public class ArticleDetailFragment extends Fragment implements
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            AppBarLayout appBarLayout = mRootView.findViewById(R.id.ab_layout);
            appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
                ...
                public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                    ...
                    if (scrollRange + verticalOffset == 0) {
                        ...
                        mCollapsingToolbarLayout.setCollapsedTitleTextColor(getResources().getColor(R.color.color_detail_text));
                        isShow = true;
                    } else if (isShow) {
                        mCollapsingToolbarLayout.setTitle(" ");
                        isShow = false;
